...
<img src="../../images/about_me/usm.png" alt="Universidad Técnica Federico Santa María" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
...
<div style="display: flex; align-items: center; margin-bottom: 30px; gap: 20px;">
<img src="../../images/about_me/logo_sn2.png" alt="Seth&Nut" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
...
<div style="display: flex; align-items: center; margin-bottom: 30px; gap: 20px;">
<img src="../../images/about_me/datadomz.png" alt="DataDomz" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
...
<div style="display: flex; align-items: center; margin-bottom: 30px; gap: 20px;">
<img src="../../images/about_me/laptop.png" alt="Consultor Independiente" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
<strong>Consultor</strong><br>
Independiente<br>
Abr 2020 – Sep 2024
...
<div style="display: flex; align-items: center; margin-bottom: 30px; gap: 20px;">
<img src="../../images/about_me/cake.png" alt="Mercadito Alegre" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
...
<div style="display: flex; align-items: center; margin-bottom: 30px; gap: 20px;">
<img src="../../images/about_me/uni.png" alt="Escuela Particular Fray Luis Beltrán" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
...
<div style="display: flex; align-items: center; margin-bottom: 30px; gap: 20px;">
<img src="../../images/about_me/uni.png" alt="Jardín Infantil Snoopy" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
...
<div style="display: flex; align-items: center; margin-bottom: 30px; gap: 20px;">
<img src="../../images/about_me/dupont.png" alt="Dupont" style="width: 65px; height: 65px; object-fit: contain; flex-shrink: 0;">
<div>
